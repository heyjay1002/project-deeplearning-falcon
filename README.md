...
- [주요 기능](#2-주요-기능)
- [핵심 기술](#3-핵심-기술)  
  - [시뮬레이션 기반 위험 예측](#1-시뮬레이션-기반-위험-예측)  
  - [객체 탐지 (Object Detection)](#2-객체-탐지-object-detection)  
  - [객체 추적 (Object Tracking)](#3-객체-추적-object-tracking)  
  - [자세 감지 (Pose Estimation)](#4-자세-감지-pose-estimation)  
  - [좌표계 변환 (Coordinate Mapping)](#5-좌표계-변환-coordinate-mapping)
- [기술적 문제 및 해결](#4-기술적-문제-및-해결)
- [시스템 설계](#5-시스템-설계)
- [프로젝트 구조](#6-프로젝트-구조)
- [기술 스택](#7-기술-스택)
- [프로젝트 일정 관리](#8-프로젝트-일정-관리)
- [팀 구성](#9-팀-구성)
