...
- [주요 기능](#주요-기능)
- [핵심 기술](#핵심-기술)  
  - [시뮬레이션 기반 위험 예측](#시뮬레이션-기반-위험-예측)  
  - [객체 탐지 (Object Detection)](#객체-탐지-object-detection)  
  - [객체 추적 (Object Tracking)](#객체-추적-object-tracking)  
  - [자세 감지 (Pose Estimation)](#자세-감지-pose-estimation)  
  - [좌표계 변환 (Coordinate Mapping)](#좌표계-변환-coordinate-mapping)
- [기술적 문제 및 해결](#기술적-문제-및-해결)
- [시스템 설계](#시스템-설계)
- [프로젝트 구조](#프로젝트-구조)
- [기술 스택](#기술-스택)
