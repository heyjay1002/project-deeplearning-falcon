...
def test_medium_model():
    """Medium 모델 테스트"""
    print("=== Medium 모델 STT 테스트 ===")
    
    # STT 엔진 초기화 (medium 모델, GPU 자동 선택)
    print("1. STT 엔진 초기화 중...")
    stt_engine = WhisperSTTEngine(model_name="medium", language="ko", device="auto")
...
def main():
    ...
    print("\n=== 테스트 완료 ===")
    print("Medium 모델은 RTX 2060에서 최적의 성능/품질 균형을 제공합니다.")
